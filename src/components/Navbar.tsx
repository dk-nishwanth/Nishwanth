...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-4 lg:px-6 py-4 lg:py-6">
        <Link to="/" className={`flex items-center gap-2 group ${textColor === "text-white" ? "text-white" : "text-shift-black"}`}>
          <div className={`w-6 h-6 lg:w-8 lg:h-8 flex items-center justify-center rotate-45 transition-transform group-hover:rotate-90 ${textColor === "text-white" ? "bg-white" : "bg-shift-black"}`}>
            <div className={`w-3 h-3 lg:w-4 lg:h-4 border-2 ${textColor === "text-white" ? "border-shift-black" : "border-white"}`}></div>
          </div>
        ...
        <button 
          ...
          className={`flex items-center gap-2 group transition-colors ${textColor}`}
        >
          <div className="flex flex-col gap-1 items-end">
            <div className={`h-[1px] w-8 transition-all group-hover:w-12 ${textColor === "text-white" ? "bg-white" : "bg-shift-black"}`}></div>
            <div className={`h-[1px] w-6 transition-all group-hover:w-12 ${textColor === "text-white" ? "bg-white" : "bg-shift-black"}`}></div>
          </div>
